...
export default (strings = new LocalizedStrings({
  it: {
    ...
    piva: "P.IVA",
    IBAN: "IBAN",
    telematic_address: "INDIRIZZO TELEMATICO (PEC)",
    Telematic_address: "Indirizzo telematico (PEC)",
    confirm_iban_change: "Modificando il codice IBAN dovrai riattivare un nuovo contratto SDD",
    ...
    YOUR_BALANCE: "HAI ATTUALMENTE ",
    wallet_credit: "crediti",
    wallet_credit_recharge: "Il tuo credito si ricaricherà il",
    // cart
    cart_title: "CARRELLO",
    Delete: "Togli",
    cart_total1: "TOTALE (iva e costi di spedizione inclusi)",
    cart_total2: "(iva e costi di spedizione inclusi)",
    SHIPPING_FEES: "SPESE DI SPEDIZIONE",
    discount: "SCONTO",
    cart_total_text: "Totale Provvisorio",
    cart_check_out: "CHECK OUT",
    error: "ERRORE: ",
    error_email: "Prima di fare un ordine verifica nel tuo profilo di aver inserito un indirizzo valido ed una mail valida",
    ...
    ADDRESS: "INDIRIZZI",
    //trenod card
    trenord:"TRENORD CARD",
    tren_card: "TRENORD Card number",
    lomb_card: "Regione Lombardia",
    user_enable: "Abilitazione utenti",
    request_verification: "VALIDA",
    enable_discount: "Abilita sconto 10%",
    free_shipping: "Abilita spedizione gratuita",
    cardholder_convention: "CONVENZIONE TITOLARI TESSERA TRENORD",
    trenord_content1: "Abilita la convenzione ed  inserisci il numero di tessera. Una volta verificata la validità della  tessera, potrai accedere ai vantaggi riservati agli abbonati Trenord scegliendo tra :",
    trenord_point1:"Sconto del 10% sulla tua spesa",
    trenord_point2:"Consegna gratuita a casa* (attiva nei comuni di Milano e Busto Arsizio)",
    trenord_content2:"Potrai modificare la tua scelta ogni volta che lo desideri.",
    number_only: "Aggiungi solo numeri",
    enable_convention: "RICHIEDI VERIFICA",
    card_success: "Conferma - Tessera attivata",
    //payment
    payment_method: "METODO DI PAGAMENTO",
    cardPage: "DATI CARTA DI CREDITO",
    ...
    inactive_state: "STATO DISATTIVO",
    PROFILE: "PROFILO",
    My_details: "I tuoi dettagli",
    Password_change: "Cambia Password",
    Confirm_password: "Conferma Password",
    Password: "Password",
    activate_sdd_success: "Complimenti, da questo momento puoi pagare con SDD.",
    activate_sdd_failed: "Il mandato non è andato a buon fine di contattare la propria banca.",
    enter_activation_code: "Inserisci il codice di attivazione ricevuto",
    info_about_activation_code: "Richiesta effettuata. Riceverai a breve un codice di attivazione. ",
    confirm_activate_sdd: "Sei sicuro di voler attivare il pagamento SDD?",
    confirm_deactivate_sdd: "Sei sicuro di voler disabilitare il pagamento SDD?",
    password_updated: "Password modificata",
    fill_both_password: "Riempire entrambi i campi Password e Conferma Password",
    ...
    do_you_want_notification: "Vuoi ricere le notifiche sulla scadenza dei prodotti da te acquistati?",
    notif_tutorial: "Notifiche e Tutorial",
    Privacy_Policy: "Privacy Policy",
    notification_state: "NOTIFICHE ATTIVE",
    view_toturials: "Visualizza il tutorial per imparare a utlizzare l’app di Prontolo",
    //Address Form
    Province: "Provincia",
    State: "Stato",
    ...
    Error: "Error !!",
    not_present: "Devi compilare i campi",
    failed_sdd: "Il mandato non è andato a buon fine, si prega di contattare la propria banca",
    Processing: "In elaborazione...",
    was_removed: " é stato rimosso.",
    Searchingfor: "Ricerca in corso ",
    Updating: "Aggiornamento in corso…",
    minimum_char: " caratteri minimi richiesti",
    char_needed: " caratteri richiesti",
    invalid: " Invalida ",
    ...
    logged_out: "Logout effettuato correttamente",
    cancel: "ANNULLA",
    continue: "CONFERMA",
    PAYMENT_SUCCESS_1: "IL PAGAMENTO",
    PAYMENT_SUCCESS_2: "CON CARTA DI CREDITO",
    PAYMENT_SUCCESS_3: "È ANDATO A BUON FINE",
    PAYMENT_FAIL_1: "IL PAGAMENTO",
    PAYMENT_FAIL_2: "CON CARTA DI CREDITO",
    PAYMENT_FAIL_3: "NON È ANDATO A BUON FINE",
    VERIFY_DATA: "VERIFICA NUOVAMENTE I DATI",
    // font
    ...Platform.select({
      ios: {
        lBold: "Lato-Bold",
